...
const Footer = () => {
  ...
  return (
    <footer
      id="contato"
      className="bg-dark-bg text-white pt-10 pb-2.5 w-full overflow-x-hidden"
    >
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-2 mt-4">
              <p className="text-sm text-text-light leading-relaxed">
                Segunda a Quinta: 11:00 às 23:00
              </p>
              <p className="text-sm text-text-light leading-relaxed">
                Sexta e Sábado: 11:00 às 00:00
              </p>
              <p className="text-sm text-text-light leading-relaxed">
        ...
        <div className="text-center pt-5 border-t border-primary/30 text-sm text-gray-400">
          <p>
            &copy; {currentYear} Barra Bambu Restaurante. Todos os direitos
            reservados.
          </p>
          <p className="text-sm text-text-light leading-relaxed flex items-center justify-center gap-2">
            <span>Desenvolvido com</span>
            <span className="text-red-500 animate-pulse">❤️</span>
            <span>por</span>
            <span className="text-primary font-bold border-b border-primary/30 pb-0.5">
              Wagner Guimaraes
            </span>
          </p>
        </div>
