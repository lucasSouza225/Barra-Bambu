        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <div className="space-y-4 text-text-dark/80 leading-relaxed">
              <p>
                Bem-vindo ao <strong className="text-primary">BARRA BAMBU</strong>, Restaurante e Choperia. 
                Desfrutando com satisfação única sobre a experiência memorável com pratos sempre no ponto. 
                Cozinha perfeita e atendimento de primeira classe transformam cada detalhe e a vinda para 
                transformar cada almoço em família, ao artesanal experiência memorável com pratos sempre no ponto.
              </p>
              <p>
                Cozinha perfeita e atendimento de primeira classe transformam cada detalhe e a vinda para 
                transformar cada almoço em família, ao artesanal experiência memorável com pratos sempre no ponto.
